<?php
  ...
  // favourites.php
  //
  // Display the list of all the user's favourited shows
  //=============================================================================
  ...
  // Get and display all favourited shows of the user
  ...
  $all_favourites_results = array();
	...
	// Show message if user doesn't have any favourites
	if ($num_favourites <= 0) {
...
<script type='text/javascript'>
	...
	// Update the list of favourites displayed as the user removes items
	$(function() {
